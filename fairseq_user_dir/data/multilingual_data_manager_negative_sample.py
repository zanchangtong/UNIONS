"""
This code has been modified based on class MultilingualDatasetManager to suit the current requirements.
"""
import itertools
import json
import logging
...
from .language_pair_with_negative_dataset import LanguagePairWithNegativeDataset
...
class MultilingualDatasetWithNegativeManager(object):
    ...
    def setup_data_manager(cls, args, lang_pairs, langs, dicts, sampling_method):
        return MultilingualDatasetWithNegativeManager(
    ...
    def load_langpair_dataset(
        ...
        return LanguagePairWithNegativeDataset(
            src_dataset,
            src_dataset.sizes,
            src_dict,
            tgt_dataset,
