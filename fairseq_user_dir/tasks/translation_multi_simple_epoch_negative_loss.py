"""
This code has been modified based on class TranslationMultiSimpleEpochTask to suit the current requirements.
"""
...
from ..data.multilingual_data_manager_negative_sample import MultilingualDatasetWithNegativeManager
...
@register_task("translation_multi_simple_epoch_negative_loss")
class TranslationMultiSimpleEpochNegativeLossTask(LegacyFairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--add-mask', action='store_true',
                            help='add mask into dictionary, where the pretrained model is trained with self-supervised task)')

        SamplingMethod.add_arguments(parser)
        MultilingualDatasetWithNegativeManager.add_args(parser)
        # fmt: on
    ...
    def __init__(self, args, langs, dicts, training):
        ...
        self.data_manager = MultilingualDatasetWithNegativeManager.setup_data_manager(
    ...
    def setup_task(cls, args, **kwargs):
        langs, dicts, training = MultilingualDatasetWithNegativeManager.prepare(
